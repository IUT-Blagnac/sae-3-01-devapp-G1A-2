...
immage::https://github.com/IUT-Blagnac/sae-3-01-devapp-G1A-2/blob/master/images-ressources/modifCompteRetour.png[width=400, link="https://github.com/IUT-Blagnac/sae-3-01-devapp-G1A-2/blob/master/images-ressources/modifCompteRetour.png"] 
...
Vous pouvez consulter votre panier en cliquant sur le logo de caddie 

image::https://github.com/IUT-Blagnac/sae-3-01-devapp-G1A-2/blob/master/images-ressources/RedirectionSuprCompte.png[width=400, link="https://github.com/IUT-Blagnac/sae-3-01-devapp-G1A-2/blob/master/images-ressources/RedirectionSuprCompte.png"] 

Une fois avoir cliquer sur le caddie vous êtes redirigé vers votre panier 
