...
<body>
    <center>
        <h1 style="margin-bottom:30px;">Liste des produits non disponibles (statut supprimé)</h1>
    </center>
    <?php
    ...
    if (!empty($_POST['barreRecherche'])) {
        ...
        $tabProducts = list_products_deleted_filtered($conn, $motCleRecherche);
        //var_dump($tabProducts);
    } else {
        // sinon on affiche tous les produits 
        $tabProducts = list_products_deleted($conn); // appel à la fonction de traitProduitDashboard qui retourne la liste de tous les produits
        //var_dump($tabProducts);
    }
        ...
        foreach ($tabProducts as $prod) {
            ...
            <div class="card shadow-sm h-100 d-flex flex-column justify-content-between">
                ...
                <div class="card-body text-center d-flex flex-column justify-content-between">
                    ...
                    <a href="restaurerProdAdmin.php?idProduit=' . urlencode($prod["IDPRODUIT"]) .  '" class="btnlinkadmin">
