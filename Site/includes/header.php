...
<head>
    ...
    <!-- Ajouter cette ligne dans le <head> de votre HTML pour charger Font Awesome -->
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <img src="images/iconEntreprise.png" class="img-fluid d-inline-block align-top me-2" alt="Logo" style="height: 50px; width: auto;">
                    <a class="navbar-brand mb-0" style="font-weight: 700; color: rgb(2, 164, 21);" href="index.php">Style et Semelle.</a>
                </div>
               ...
               <!-- Barre de recherche centrée -->
                <div class="search-container d-flex align-items-center flex-grow-1 justify-content-center" style="flex-basis: 300px; max-width: 600px;">
                    ...
                    <form action="listeProduits.php" method="GET" class="d-flex w-100">
                        <!-- Champ de recherche -->
                        <input class="form-control rounded-pill me-2" type="search" name="barreRecherche" placeholder="Rechercher..." aria-label="Search" required>
                        <!-- Bouton de recherche -->
                ...
                <div class="d-flex icons-redirec" style="gap: 1.5rem;">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg-end dropdown-menu-start" aria-labelledby="userDropdown">
                    ...
                    <!-- Icône du panier -->
                    <a 
                        href="<?php echo isset($_SESSION['user']) ? 'panier.php' : 'login.php'; ?>" 
                        class="nav-icon me-3" 
